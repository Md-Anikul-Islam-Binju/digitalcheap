                ...
                <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                    ...
                    @foreach($service as $key=>$serviceData)
                        <tr>
                            ...
                            <td>
                                <img src="{{asset('images/service/'. $serviceData->file )}}" alt="Current Image" style="max-width: 50px;">
                            </td>
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" id="name" name="name" value="{{$serviceData->name}}"
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <img src="{{asset('images/service/'. $serviceData->file )}}" alt="File or  Image" class="mt-2" style="max-width: 50px;">
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="mb-3">
